...
ActiveRecord::Schema.define(version: 20170626004605) do
  ...
  add_index "friendships", ["initiator_id", "receiver_id"], name: "index_friendships_on_initiator_id_and_receiver_id", unique: true, using: :btree
